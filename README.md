...
`3plekode/hugo` is a [Docker](https://www.docker.io) base image for static sites generated with [Hugo](http://gohugo.io).
...
Using your image as a stand-alone image is the easiest:
    ...
    docker run -p 1313:1313 3plekode/hugo

This will automatically start `hugo server`, and your blog is now available on http://localhost:1313.

If you are using `boot2docker`, you need to adjust the base URL:

    docker run -p 1313:1313 -e HUGO_BASE_URL=http://YOUR_DOCKER_IP:1313 3plekode/hugo
...
The image is also suitable for use as a volume image for a web server, such as [nginx](https://registry.hub.docker.com/_/nginx/)
    ...
    docker run -d -v /usr/share/nginx/html --name site-data 3plekode/hugo
